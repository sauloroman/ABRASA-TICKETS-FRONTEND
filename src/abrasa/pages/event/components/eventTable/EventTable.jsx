              ...
              <tr key={ticket.id} className="event-table__tr">
                ...
                <td className="event-table__td ">
                  <a
                    ...
                    target='_blank'
                    href={`https://wa.me/52${ticket.phone}?text=Hola ${ticket.name}. El equipo de ${event?.client || 'EventCreations'} te saluda cordialmente 🔥.Queremos mandarte tu invitación web para tu próximo evento el ${event.eventDate}. Compártela únicamente con tus invitados y reserva tu esperada fecha. %0A%0A🌐Invitación web: ${event.invitation} %0A🔑Clave de acceso: ${ticket.keyPass} %0A%0A Nota: No compartas esta clave con nadie más pues tus boletos electrónicos pueden ser clonados. Presenta tus boletos el día de tu evento y listo 🔥.`}>
                    <i
                      title="Enviar Boleto"
